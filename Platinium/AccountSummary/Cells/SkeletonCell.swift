...
class SkeletonCell: UITableViewCell { //mirror of accountsummarycell
...
extension SkeletonCell {
    private func setup() {
        ...
        balanceAmountLabel.translatesAutoresizingMaskIntoConstraints = true
        balanceAmountLabel.textAlignment = .right
        balanceAmountLabel.text = "-XXX,XX.X-"
