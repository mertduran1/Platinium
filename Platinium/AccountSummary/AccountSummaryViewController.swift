//
//  AccountSummaryViewController.swiftimport UIKit
import UIKit
...
extension AccountSummaryViewController {
    ...
    private func setupTableView() {
        tableView.backgroundColor = appColor //TableView arkadan aşağı çekerken bir kısmı beyaz görünüyor. beyazlığı engellemek icin
